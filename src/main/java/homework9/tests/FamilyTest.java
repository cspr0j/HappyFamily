...
public class FamilyTest {
    ...
    void toStringIsValid() {
        Human father = new Human("Stanley", "Kubrick", 1928,80);
        Human mother = new Human("Christiane", "Kubrick", 1932,60);
    ...
    @Test
    void deleteChild1() {
        Human father1 = new Human("Stanley", "Kubrick", 1928,80);
        Human mother1 = new Human("Christiane", "Kubrick", 1932,60);
    ...
    void iaEquals() {
        ...
        Human father2 = new Human("Stanley", "Kubrick", 1928,80);
        Human mother2 = new Human("Christiane", "Kubrick", 1932,60);
        ...
        Human father3 = new Human("Stanley", "Kubrick", 1928,80);
        Human mother3 = new Human("Christiane", "Kubrick", 1932,60);
